...
D = Department(name='VIII. УПРАВЛІННЯ представництва, захисту інтересів громадян та держави в суді',
               prosecutors_office=PO)
D.save()

##################################################################

d1 = Division(name='1) Відділ організації представництва на захист інтересів громадянина або держави',
              prosecutors_office=PO, department=D)
d1.save()

d2 = Division(name='2) Відділ представництва інтересів громадян і держави в судах', prosecutors_office=PO, department=D)
d2.save()

d3 = Division(name='3) Відділ представництва при виконанні судових рішень', prosecutors_office=PO, department=D)
d3.save()

d4 = Division(name='4) Організаційно-методичний відділ', prosecutors_office=PO, department=D)
d4.save()

##################################################################

e1 = Employee(name='Ярослав', surname='Заворотний', patronymic='Семенович', position=p1,
              private_telephone='050-336-08-57', prosecutors_office=PO, department=D, division=d1)
e1.save()

e2 = Employee(name='Максим', surname='Ракович', patronymic='Миколайович', position=p2, work_telephone='1500;731-98-62',
              private_telephone='067-484-46-84', prosecutors_office=PO, department=D, division=d1)
e2.save()

e3 = Employee(name='Сергій', surname='Бондарев', patronymic='Юрійович', position=p3, work_telephone='1514;731-99-63',
              private_telephone='743-69-98', prosecutors_office=PO, department=D, division=d2)
e3.save()

e4 = Employee(name='Олексій', surname='Котелевський', patronymic='Іванович', position=p2, work_telephone='1105;731-98-67',
              private_telephone='097-307-11-25', prosecutors_office=PO)
e4.save()

e5 = Employee(name='Вадим', surname='Шивцов', patronymic='Михайлович', position=p3, private_telephone='096-288-83-90',
              prosecutors_office=PO, department=D)
e5.save()
