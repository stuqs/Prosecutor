...
e1 = Employee(name='Ярослав', surname='Заворотний', patronymic='Семенович', position=p1,
              private_telephone='0503360857', prosecutors_office=PO, department=D, division=d1)
e1.save()

e2 = Employee(name='Максим', surname='Ракович', patronymic='Миколайович', position=p2, work_telephone='1500;7319862',
              private_telephone='0674844684', prosecutors_office=PO, department=D, division=d1)
e2.save()

e3 = Employee(name='Сергій', surname='Бондарев', patronymic='Юрійович', position=p3, work_telephone='1514;7319963',
              private_telephone='7436998', prosecutors_office=PO, department=D, division=d2)
e3.save()

e4 = Employee(name='Олексій', surname='Котелевський', patronymic='Іванович', position=p2, work_telephone='1105;7319867',
              private_telephone='0973071125', prosecutors_office=PO)
e4.save()

e5 = Employee(name='Вадим', surname='Шивцов', patronymic='Михайлович', position=p3, private_telephone='0962888390',
              prosecutors_office=PO, department=D)
e5.save()
